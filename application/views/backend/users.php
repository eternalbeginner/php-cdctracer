        ...
        <div class="card-header">
          ...
          <?php if ($title == "2") : ?>
            <span class="float-right">
							<a class="btn btn-secondary btn-sm text-white" data-toggle="modal" data-target="#modal_import">
								<i class="fa fa-upload"></i>
								Import Data
							</a>
              <a class="btn btn-primary btn-sm text-white" data-toggle="modal" data-target="#modal_tambah">
          ...
          <?php elseif ($title == "3") : ?>
            <span class="float-right">
              ...
              <a class="btn btn-primary btn-sm text-white" data-toggle="modal" data-target="#modal_alumni">
								<i class="fa fa-plus"></i>
								Tambah
							</a>
            </span>
            ...
            <tbody>
              ...
              foreach ($user as $user) : ?>
                <tr>
                  ...
                  <td><?php if ($title == "2") { ?> <?= $user->telp ?> <?php } else {
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <table class="table">
              ...
              <td><strong>Konsentrasi Prodi :</strong></td>
              <td>
                <?php
                foreach ($konsentrasi as $k) :
                  if ($k->id == $user->konsentrasi) {
...
<div class="modal fade" id="modal_import" role="dialog">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<form action="<?= base_url('admin/user/' . $title . '/import') ?>" method="POST" enctype="multipart/form-data">
				<div class="modal-body">
					<div class="form-group">
						<label for="inp-imported-file" class="form-label">File (.xlsx, .xls, .csv)</label>
						<input 
							type="file"
							class="form-control-file"
							id="inp-imported-file"
							name="inp-imported-file"
							/>
					</div>
				</div>
...
<div class="modal fade" id="modal_alumni" role="dialog">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
        <form action="<?= base_url('backend/users/tambah/' . $title) ?>" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <label for="telp" class="form-control-label">Phone</label>
            <input type="text" class="form-control" name="telp">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label for="tahun_lulus" class="form-control-label">Tahun Lulus</label>
          ...
          <div class="form-group">
            <label for="konsentrasi" class="form-control-label">Konsentrasi</label>
          ...
          <div class="form-group">
            <label for="bidang_pekerjaan" class="form-control-label">Bidang Pekerjaan</label>
            <select name="bidang_pekerjaan" class="form-control">
              <?php foreach ($bidang_pekerjaan as $p) : ?>
