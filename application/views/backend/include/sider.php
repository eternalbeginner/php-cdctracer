<aside class="main-sidebar sidebar-dark-primary" style="z-index: 1;">
	<!-- Brand Logo -->
	<a href="<?= base_url('admin') ?>" class="brand-link">
		<!-- <img src="assets/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
        style="opacity: .8"> -->
		<span class="brand-text font-weight-light">SMK Negeri 2 Tabanan</span>
	</a>
			...
			<div class="info ml-2">
				<a href="#" class="d-block">
					<?php if ($this->session->userdata('id_user_grup') != '4') : ?>
						<?= ucfirst($this->session->userdata('nama_depan')) . " " . ucfirst($this->session->userdata('nama_belakang')) ?>
					<?php else : ?>
			...
			<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
				...
				<?php if ($this->session->userdata('id_user_grup') != '4') : ?>
					...
					<?php if ($this->session->userdata('id_user_grup') == 1) : ?>
						<li class="nav-item">
							<a href="<?= base_url('admin/kepsek'); ?>" class="nav-link">
								<i class="nav-icon fas fa-users"></i>
								<p>Kepala Sekolah</p>
							</a>
						</li>
						<li class="nav-item">
							<a href="<?= base_url('admin/loker'); ?>" class="nav-link">
