...
<head>
  ...
  <title>SMK Negeri 2 Tabanan</title>
    ...
    <div class="d-flex flex-column">
      ...
      <nav class="nav-menu">
        <ul>
          ...
          <li><a href="#services"><i class="bx bx-server"></i> Survei Tracer</a></li>
  ...
  <main id="main">
            ...
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  ...
                  <li><i class="icofont-rounded-right"></i> <strong>Bidang Pekerjaan: </strong><?php foreach ($bidang_pekerjaan as $bp) : if ($bp->id == $user->bidang_pekerjaan) {
                                                                                                    echo $bp->nama;
                                                                                                  }
                                                                                                endforeach; ?></li>
                </ul>
              ...
              <div class="col-lg-6">
                <ul>
                  ...
                  <li><i class="icofont-rounded-right"></i> <strong>Konsentrasi Prodi:</strong> <?php foreach ($konsentrasi as $k) : if ($k->id == $user->konsentrasi) {
                                                                                                    echo $k->konsentrasi;
                                                                                                  }
                                                                                                endforeach; ?> </li>
                </ul>
            ...
            <div class="col-lg-3 col-md-4 portfolio-item filter-app">
              <div class="portfolio-wrap">
                ...
                <div class="portfolio-links">
                  ...
                  <a href="<?= base_url('loker/' . $loker->id . '/detail') ?>" title="Detail Loker"><i class="bx bx-link"></i></a>
                </div>
              </div>
            </div>
          <?php endforeach ?>
      ...
      <div class="container">
        ...
        <div class="row" data-aos="fade-in">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                <form action="<?= base_url('loker/create/' . $this->session->userdata('id')) ?>" method="POST" enctype="multipart/form-data">
    ...
    <section id="services" class="services">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Pengisian Tracer Study</h2>
          <p>Silahkan isi tracer study berikut di bawah ini dimulai dari bagian TRACER STUDY DIKTI PUSAT, TRACER STUDY KELULUSAN, TRACER STUDY KONTRIBUSI. Dimohon untuk mengisi survei dengan baik dan benar</p>
        </div>
