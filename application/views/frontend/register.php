...
<head>
    ...
    <title>Tracer Study Institut Agama Islam Al Khoziny</title>
    <!-- Font Icon -->
                ...
                <div class="signup-content">
                    ...
                    <div class="signup-form">
                        <h2 class="form-title dua"> halah </h2>
                            <div class="form-group">
                                <label for="Angkatan"><i class="zmdi zmdi-calendar-check"></i></label>
                                <input type="text" name="mulai_kerja" id="datepicker3" placeholder="Mulai Kerja Tahun" required/>
                            </div>
                            <div class="form-group">
                                <label for="pekerjaan"><i class="zmdi zmdi-account-box-mail"></i></label>
                                <select name="konsentrasi" id="pekerjaan" required>
                                    <option selected>Pilih Konsentrasi Prodi Anda</option>
