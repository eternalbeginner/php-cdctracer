...
--
DROP DATABASE IF EXISTS `tracerstudy`;
CREATE DATABASE `tracerstudy` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `tracerstudy`;
...
--
-- Pembuatan: 04 Apr 2022 pada 02.16
--

DROP TABLE IF EXISTS `bidang_pekerjaan`;
...
--
-- Pembuatan: 04 Apr 2022 pada 02.16
-- Pembaruan terakhir: 05 Apr 2022 pada 06.36
--

DROP TABLE IF EXISTS `hasilkmeans`;
...
--
-- Pembuatan: 04 Apr 2022 pada 02.16
-- Pembaruan terakhir: 04 Apr 2022 pada 02.30
--
...
--
-- Pembuatan: 05 Apr 2022 pada 06.20
-- Pembaruan terakhir: 05 Apr 2022 pada 06.20
--
...
CREATE TABLE `kepala_sekolah` (
  ...
  `password` varchar(255) NOT NULL DEFAULT '21232f297a57a5a743894a0e4a801fc3',
...
INSERT INTO `kepala_sekolah` (`id`, `id_user_grup`, `nama`, `nip`, `telp`, `email`, `password`, `alamat`) VALUES
(1, 4, 'Bagas New', '198503302003121002', '081234567890', 'test.kepsek@gmail.com', '21232f297a57a5a743894a0e4a801fc3', 'Jl. Test No. 1');
...
--
-- Pembuatan: 04 Apr 2022 pada 02.16
-- Pembaruan terakhir: 04 Apr 2022 pada 13.15
--
...
(8, 27, 'Test', '<p>Test</p>', '28 04 2022', '27 04 2022', 'Image_-_17.jpg', 'unpublish'),
(9, 24, 'Test Admin', '<p>Test Admin</p>', '21 04 2022', '25 04 2022', 'Image_-_171.jpg', 'unpublish');
...
(5, 'TRACER STUDY DIKTI PUSAT', 'Survei ini dibuat berdasarkan borang tracer study dari dikti', '30 08 2020', '', '17 09 2020'),
(6, 'TRACER STUDY KELULUSAN', 'Pada saat lulus, pada tingkat mana kompetensi di bawah ini anda kuasai? ', '', '', '17 09 2020'),
(7, 'TRACER STUDY KONTRIBUSI', 'Pada saat lulus, bagaimana kontribusi perguruan tinggi dalam hal kompetensi di bawah ini?', '', '', '17 09 2020');
...
DROP TABLE IF EXISTS `survei_jawaban`;
...
--
-- Pembuatan: 04 Apr 2022 pada 02.16
-- Pembaruan terakhir: 05 Apr 2022 pada 02.41
--
...
(1, 1, 'Bagja septian', 'munawar', 'L', '2020-06-01', '083821354485', 'bagja672@gmail.com', '', 'bagjaseptian', '21232f297a57a5a743894a0e4a801fc3', '2020-06-25', '2020-06-25', '', '', '', '', '0', 'admin.jpg', 'aktif'),
(24, 1, 'admin', 'istrator', 'L', '', '', '', '', 'admin', '21232f297a57a5a743894a0e4a801fc3', '', '', '', '', '', '', '', 'admin.jpg', 'aktif'),
(27, 2, 'Panitia', 'Tracer', 'L', '', '0832827371', 'panitiatracer@gmail.com', 'jl karapitan no11', 'panitiatracer', '627bb0a29d40c0570bd923b827c9070c', '', '', '', '', '', '', '', 'admin.jpg', 'aktif'),
(47, 3, 'Budiman', 'rahayu', 'L', '05 August 2020', '0821435784932', 'fahmyal080397@gmail.com', 'jl karapitan no11', 'mahasiswa', '5787be38ee03a9ae5360f54d9026465f', '2019', '2019', '2015', '1', '1', 'Jalan Taman sari no 109', 'Bandung', 'download.png', 'aktif'),
...
(67, 3, 'Rando', 'Kartiko', 'L', '31 January 1989', '08789809000', 'aibarrizki@gmail.com', 'JL.Merdeka no.21', 'rando', '25d55ad283aa400af464c76d713c07ad', '2009', '2019', '2009', '1', '2', 'JL. Merdeka No.55', 'Jakarta', 'admin.jpg', 'aktif'),
(68, 3, 'Randita', 'Lisa', 'P', '04 January 1999', '08789094000', 'randita@gmail.com', 'JL. TB.Simatupang no.11 Jakarta', 'randita', '25d55ad283aa400af464c76d713c07ad', '2019', '2020', '2019', '1', '1', 'JL. Merdeka Barat No.12 Jakarta Selatan', 'Jakarta', '17833962_1429058190467467_5643204336912861571_o.jpg', 'aktif'),
(69, 3, 'Raka', 'Rakinta', 'L', '07 February 1989', '087774657344', 'raka@gmail.com', 'JL.Merdeka No.32', 'mhsraka', '7a39fda54aeb30241abfa6f693ded24f', '2019', '2021', '2019', '4', '4', 'JL.merdeka No.11', 'Jakarta', 'logo.png', 'aktif'),
(73, 3, 'Test', 'User', 'L', '2022-04-13', '081234567890', 'blackpinkishere@gmail.com', 'Jl. Testing', 'needusernameplz', 'd936f6bf392421f8360b29f8061ea3fd', '2021', '', '2018', '4', '3', '', 'Denpasar', 'Image_-_22.jpg', 'aktif'),
(74, 2, 'Test', 'User', 'P', '2022-04-15', '081234567890', 'blackpinkishere@gmail.com', 'Jl. Testing', 'notagamer', '2139f27299c47daa251de8d4fab3fa4a', '', '', '', '', '', '', '', 'Image_-_171.jpg', 'nonaktif');
...
--
-- Pembuatan: 04 Apr 2022 pada 02.16
-- Pembaruan terakhir: 05 Apr 2022 pada 06.16
--
...
(4, 'Kepala Sekolah', 'Grup untuk kepala sekolah');
